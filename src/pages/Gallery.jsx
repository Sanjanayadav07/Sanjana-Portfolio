...
const IMAGES = {
  ...
  projects: [

    {
      ...
      caption:
        "📂Street Food",
      photos: ["/gallery/1.png", "/gallery/2.png", "/gallery/3.png", "/gallery/4.png"],
    },
  ],
  achievements: [
    {
      id: 1,
      caption: "Solved 500 LeetCode questions 🏆!",
      photos: ["/gallery/leet.png"],
    },
    {
      id: 2,
      caption: "Participated in Young_turks25 🤖",
      photos: ["/gallery/5.png"],
    },
    {
      id: 3,
      caption: "Selected Participant – Frontend Battle 2.0 organized by IIT Bhubaneswar",
      photos: ["/gallery/17.png"],
    },
    {
  id: 4,
  caption: "Open Source Contributor – Successfully merged 1 Pull Request in GirlScript Summer of Code (GSSoC), contributing to a real-world collaborative project.",
  photos: ["/gallery/18.jpeg"],
}
