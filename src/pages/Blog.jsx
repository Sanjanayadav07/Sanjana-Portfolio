...
export default function Blog() {
  ...
  text: "Building full stack applications allows me to work on both the frontend and backend, turning ideas into complete, functional products. From designing responsive user interfaces to developing secure APIs and managing databases, I enjoy creating end-to-end solutions that solve real-world problems and deliver seamless user experiences."
  },
